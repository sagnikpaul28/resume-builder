<template>
    <div class="editor">
        ...
        <draggable class="list-group" :list="awards" group="people"> 
            <transition-group>
                <div class="row" v-for="(award, index) in awards" :key="index">
                    <div class="col">
                        <div class="content">
                            {{award.name}}
                    ...
                    <div class="popup" :class="{'show': award.showModal}">
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="input-containers">
                                    <label>Date:</label>
                                    <input type="text" v-model="award.date" />
                                </div>
                            </div>
                            <div class="col">
                                <div class="input-containers">
                                    <label>Institution:</label>
                                    <input type="text" v-model="award.institution" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="input-containers">
                                    ...
                                    <textarea rows="4" v-model="award.description" />
                                </div>
                            </div>
                        </div>
        ...
        <div class="row footer">
            <button class="btn add" @click="toggleNewItemModal()">Add Awards</button>
        ...
        <div class="popup" :class="{'show': showNewItemAddModal}">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="input-containers">
                        <label>Institution:</label>
                        <input type="text" v-model="newFields.institution" />
                    </div>
                </div>
            </div>
            <div class="row">
...
export default {
    ...
    computed: {
        ...
        newFields() {
            return this.$store.state.newFields.awards
        }
    },
    methods: {
        openModal(index) {
