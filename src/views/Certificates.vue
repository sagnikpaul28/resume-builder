<template>
    <div class="editor">
        ...
        <div class="row footer">
            <button class="btn add-new" @click="toggleNewItemModal()"><span>+</span> Add certificates</button>
        ...
        onButtonSubmit() {
            fetch('http://localhost:4000/save-details', {
                ...
                body: JSON.stringify({
                    ...
                    "field": "certificates",
                    "value": JSON.stringify(this.certificates)
                }),
                headers: {
                    'Content-Type':'application/json',
                }
            }).then(() => {
                this.$store.dispatch('afterLayoutChooseNextState', 'certificates').then(() => {
